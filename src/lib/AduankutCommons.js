...
// Menu
// ================================================================================================================
export function AduankutMenu({ githubUser }) {
  const [isMenuOpen, setMenuState] = React.useState(false);
  return (
    <AduankutMenu.Wrapper isMenuOpen={isMenuOpen}>
      <div className="container">
        <AduankutMenu.Logo src={`${BASE_URL}/logo.svg`} />
      ...
      <AduankutMenuProfileSidebar githubUser={githubUser} />
    </AduankutMenu.Wrapper>
  )
}
AduankutMenu.Wrapper = styled.header`
  width: 100%;
  background-color: #308BC5;
  .AduankutMenuProfileSidebar {
    background: white;
    position: fixed;
    z-index: 100;
    padding: 46px;
...
function AduankutMenuProfileSidebar({ githubUser }) {
  return (
    <div className="AduankutMenuProfileSidebar">
      <div>
...
// AduankutProfileSidebarMenuDefault
// ================================================================================================================
export function AduankutProfileSidebarMenuDefault() {
  return (
    <AduankutProfileSidebarMenuDefault.Wrapper>
      <nav>
        <a href="/">
...
AduankutProfileSidebarMenuDefault.Wrapper = styled.div`
  a {
    font-size: 12px;
    color: #2E7BB4;
    margin-bottom: 16px;
...
// Reset Styles
// ================================================================================================================
export const AduankutStyles = css`
  *::-webkit-scrollbar {
    width: 8px;
  }
